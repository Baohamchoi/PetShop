...
function renderItems(items) {
  ...
  items.forEach(item => {
    ...
    itemProducts += renderCosmeticCard(name, price, imgMain);
  });
  document.getElementById('clothes').innerHTML = itemProducts;
}

// Hàm renderFoodCard
function renderCosmeticCard(name, price, imgMain) {
