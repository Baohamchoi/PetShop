...
function renderItems(items) {
  ...
  items.forEach(item => {
    ...
    itemProducts += renderCleaningCard(name, price, imgMain);
  });
  document.getElementById('cleaning').innerHTML = itemProducts;
}

// Hàm renderFoodCard
function renderCleaningCard(name, price, imgMain) {
